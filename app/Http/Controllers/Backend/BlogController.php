...
class BlogController extends BackendController
{
    ...
    public function index(Request $request)
    {
        ...
        { 
            $posts = Post::onlyTrashed()->with('category')->with('author')->latest()->paginate($this->limit); 
            $postCount = Post::onlyTrashed()->count();
            $onlyTrashed = TRUE; 

        }elseif($status == 'published') { 
            $posts     = Post::published()->with('category')->with('author')->latest()->paginate($this->limit); 
            $postCount = Post::published()->count();        
                
        }elseif($status == 'scheduled') { 
            $posts     = Post::scheduled()->with('category')->with('author')->latest()->paginate($this->limit); 
    ...
    public function destroy($id)
    {
        ...
        return redirect('/backend/blog')->with('trash-message', ['Your post was moved to the Trash', $id]); 
    }
